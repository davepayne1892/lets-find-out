...
import { MobileNavbar, Navbar } from "./ui/components/redesign/navbar";
import { WithBackgroundImage } from "./ui/components/redesign/splash-2";
            ...
            >
              <Stack flex={1} spacing={{ base: 5, md: 10 }}>
                ...
                <Text color={"gray.500"}>
                  ...
                  O, or how many animals begin with an M, or how many movies
                  begin with a G. The possibilities are... 26.
                </Text>
                <Stack
                  spacing={{ base: 4, sm: 6 }}
